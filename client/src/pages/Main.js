  ...
  return (
    <Wrapper>
      ...
      <div className="tabBox">
        <div className="hospital tabs">동물병원</div>

        <StyledLink to="/shopping">
          <div className="shopping tabs">쇼핑</div>
        </StyledLink>

        <StyledLink to="/community">
          <div className="community tabs">커뮤니티</div>
        </StyledLink>

        <StyledLink to="/notice">
          <div className="notice tabs">공지사항</div>
        </StyledLink>

        <StyledLink to="/FAQ">
          <div className="FAQ tabs">FAQ</div>
        </StyledLink>
      </div>
      {/* 메뉴 탭 컴포넌트 */}
    </Wrapper>
