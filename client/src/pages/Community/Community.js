...
function Community() {
  ...
  useEffect(() => {
    fetch(`https://shopforourpets.shop:8080/"api/v1/board?categoryId=11`, {
      method: "GET",
      headers: {
    ...
    <Wrapper>
      ...
      <div className="cpostterritory">
        <div className="cbackground">
              ...
              list.map((el, index) => {
                return (
                  ...
                  >
                    ...
                    {/* <span className="article">{el.boardId}</span> */}
                  </StyledLink>
                );
              })}
          </div>
          ...
          {/* 게시글 등록 버튼 */}
          <StyledLink to="/community/posting" className="postingbutton">
            <div>게시글 등록</div>
          </StyledLink>
        </div>
      </div>
