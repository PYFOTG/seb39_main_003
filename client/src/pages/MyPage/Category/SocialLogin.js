        ...
        <div>
            <div className='background'>
                ...
                <div className='socialLoginBox'>
                    <a href='http://shopforourpets.shop:8080/oauth2/authorization/naver' className='loginbox1'>
                        <div className='icon'>N</div>
                        <div className='textbox'>
                          <div className='text'>네이버 로그인</div>
                        </div>
                    </a>
                    <a href='http://shopforourpets.shop:8080/oauth2/authorization/kakao' className='loginbox2'>
